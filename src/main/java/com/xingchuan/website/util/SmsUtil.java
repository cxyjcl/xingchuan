package com.xingchuan.website.util;
...
public class SmsUtil {
    ...
    private static String accessKeyId = "sdfasdf";
    private static String accessKeySecret = "asdfasdf";
    private static String signName = "asdfasdfs";
    private static String identifyingTempleteCode = "asdfasfasdfasdf";
    ...
    public static SendSmsResponse sendIdentifyingCode(String mobile, String code) {
        try {
            ...
            throw new OrderException(CommonStatusEnum._ALIYUN_MSG_ERROR.getCode(),e.getMessage());
        }
    }
}