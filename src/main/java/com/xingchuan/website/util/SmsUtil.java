...
public class SmsUtil {
    ...
    private static String accessKeyId = "asda";
    private static String accessKeySecret = "asdas";
    private static String signName = "asd";
    private static String identifyingTempleteCode = "asda";
